...
for (let i = 0; i < picArray.length; i++){
	...
	publication.setAttribute("class", "card")
	
	let title = document.createElement("h2")
	title.innerHTML = picArray[i].title
	
	let figurine = document.createElement("figure")
	
	let photo = document.createElement("img")
	photo.setAttribute("src", picArray[i].image.medium)
	photo.setAttribute("alt", picArray[i].title)
	
	let caption = document.createElement("figcaption")
	caption.innerHTML = picArray[i].caption
	
	let thep = document.createElement("p")
	thep.innerHTML = picArray[i].description
	
	figurine.appendChild(photo)
	figurine.appendChild(caption)
	
	publication.appendChild(title)
	publication.appendChild(figurine)
	publication.appendChild(thep)
